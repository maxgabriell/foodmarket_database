...
CREATE TABLE IF NOT EXISTS `SESSIONS` (
  ...
  `ACCOUNT_ID` varchar(64) NOT NULL DEFAULT 0,
  `LOCATION_ID` varchar(64) NOT NULL DEFAULT 0, #localização gerada sempre quando abre o app (toda sessão tem um location_id)
  `CART_ID` varchar(64) DEFAULT 0, #pode ser nulo, o mano não pediu nada
...
CREATE TABLE IF NOT EXISTS `LOCATIONS` (
  ...
  `STREET_NUMBER` varchar(3) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `CARTS` (
  ...
  `SESSION_ID` varchar(64) NOT NULL DEFAULT 0,
  `CART_ITEM_ID` varchar(64) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `CART_ITEMS` (
  ...
  PRIMARY KEY (`CART_ITEM_ID`, `ITEM_ID`)
);
...
CREATE TABLE IF NOT EXISTS `MERCHANTS` (
  ...
  `COUSINE_TYPE` varchar(40) DEFAULT NULL,
